# WebApi.Sample SQLite schema

The WebApi.Sample creates its local SQLite tables automatically on startup so
...
```powershell
sqlite3 sensitiveflow-webapi.db ".read schema/sqlite-app.sql"
sqlite3 sensitiveflow-webapi-audit.db ".read schema/sqlite-audit.sql"
sqlite3 sensitiveflow-webapi-tokens.db ".read schema/sqlite-tokens.sql"
```
